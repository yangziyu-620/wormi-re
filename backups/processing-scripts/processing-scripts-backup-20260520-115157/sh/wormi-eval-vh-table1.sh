...
# VH Table-1-style offline evaluation from the trained stage-2 WorMI model.
...
OUTPUT_PATH="${OUTPUT_PATH:-$WORMI_CKPT_ROOT/wormi-vh-n6/table1}"
LOG_ROOT="${LOG_ROOT:-$DATA_DISK/wormi-logs}"
RUN_ID="${RUN_ID:-$(date +%Y%m%d_%H%M%S)}"
LOG_DIR="$LOG_ROOT/vh-table1-$RUN_ID"
...
echo "== WorMI VH Table-1-style eval =="
echo "root:        $ROOT_DIR"
