...
export WORMI_VH_STAGE2_GRADIENT_ACCUMULATION_STEPS="${WORMI_VH_STAGE2_GRADIENT_ACCUMULATION_STEPS:-4}"
export WORMI_ALLOW_UNSAFE_THREADED_META="${WORMI_ALLOW_UNSAFE_THREADED_META:-0}"
if [[ "$WORMI_ALLOW_UNSAFE_THREADED_META" != "1" ]]; then
  export WORMI_SEQUENTIAL_META_LEARNING=1
else
  export WORMI_SEQUENTIAL_META_LEARNING="${WORMI_SEQUENTIAL_META_LEARNING:-1}"
fi
export WORMI_VH_STAGE2_INNER_STEPS="${WORMI_VH_STAGE2_INNER_STEPS:-30}"
export WORMI_VH_STAGE2_META_STEPS="${WORMI_VH_STAGE2_META_STEPS:-8}"
...
echo "grad accum:    $WORMI_VH_STAGE2_GRADIENT_ACCUMULATION_STEPS"
echo "effective bs:  $((WORMI_VH_STAGE2_BATCH_SIZE * WORMI_VH_STAGE2_GRADIENT_ACCUMULATION_STEPS))"
echo "seq meta:      $WORMI_SEQUENTIAL_META_LEARNING"
echo "inner steps:   $WORMI_VH_STAGE2_INNER_STEPS"
echo "meta steps:    $WORMI_VH_STAGE2_META_STEPS"
